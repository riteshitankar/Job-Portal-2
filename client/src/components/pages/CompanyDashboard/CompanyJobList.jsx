            ...
            return (
              <div key={job._id} className="p-4 border rounded flex justify-between items-start">
                <div>
                  ...
                  <p className="text-sm opacity-70">{jr.category} • {jr.type} • {jr.exprience}</p>
                  <p className="text-sm opacity-60 mt-1">{jr.location}</p>
                  <p className="text-sm opacity-60">₹ {jr.offeredSalary}</p>
                </div>
